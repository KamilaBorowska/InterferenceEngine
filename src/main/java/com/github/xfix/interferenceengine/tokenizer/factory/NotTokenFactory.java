...
import com.github.xfix.interferenceengine.tokenizer.tokens.NotToken;

public class NotTokenFactory implements TokenFactory {
    ...
    @Override
    public NotToken getToken(Matcher matches) {
        return new NotToken();
    }
}
